...
something might not be working.  For example, if any of the unittests
fail, this will be detected because the output of failed unittests (in "curr")
will not match the output of the passing unittests (in "orig").
